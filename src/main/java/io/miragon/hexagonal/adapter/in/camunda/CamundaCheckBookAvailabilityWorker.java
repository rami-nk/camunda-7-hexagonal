package io.miragon.hexagonal.adapter.in.camunda;
...
public class CamundaCheckBookAvailabilityWorker implements ExternalTaskHandler {
    ...
    private final CheckBookAvailabilityUseCase checkBookAvailabilityService;
    ...
    public void execute(ExternalTask externalTask, ExternalTaskService externalTaskService) {
        ...
        final CheckBookAvailabilityCommand mappedData = this.mapInput(CheckBookAvailabilityCommand.class, data);
